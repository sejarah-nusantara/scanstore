...
<cfcomponent name="coldspring.aop.framework.tmp.bean_E95B1825BEC68EDF57BADB32A964AFC8" 
			displayname="AopProxyBean" 
			extends="coldspring.aop.framework.tmp.bean_E95B15ABEF966BCD8E23F637E055BCFA"
			hint="Abstract Base Class for Aop Proxy Beans" 
			output="false">
			
	<cffunction name="init" access="public" returntype="coldspring.aop.framework.tmp.bean_E95B15ABEF966BCD8E23F637E055BCFA" output="false">
