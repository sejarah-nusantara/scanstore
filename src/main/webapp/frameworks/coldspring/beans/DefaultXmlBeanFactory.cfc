					...
					<cfelse>
						...
						<cftry>
							...
							<cfinvoke component="#factoryBean#" method="#beanDef.getFactoryMethod()#"
								...
								<cfset argDefKeyArray = StructKeyArray(argDefs) />
								<cfif ArrayLen(argDefKeyArray) and IsNumeric(argDefKeyArray[1])>
									<cfset ArraySort(argDefKeyArray, 'numeric', 'asc')>
								</cfif>
								<cfloop from="1" to="#ArrayLen(argDefKeyArray)#" index="arg">
									<cfset argType = argDefs[argDefKeyArray[arg]].getType() />
 									<cfif argType eq "value">
										<cfinvokeargument name="#argDefs[argDefKeyArray[arg]].getArgumentName()#" value="#argDefs[argDefKeyArray[arg]].getValue()#"/>
									<cfelseif argType eq "list" or argType eq "map">
										<cfinvokeargument name="#argDefs[argDefKeyArray[arg]].getArgumentName()#" value="#constructComplexProperty(argDefs[argDefKeyArray[arg]].getValue(),argDefs[argDefKeyArray[arg]].getType(), localBeanCache)#"/>
									<cfelseif argType eq "ref" or argType eq "bean">
										<cfset dependentBeanDef = getMergedBeanDefinition(argDefs[argDefKeyArray[arg]].getValue()) />
										...
										<cfinvokeargument name="#argDefs[argDefKeyArray[arg]].getArgumentName()#" value="#dependentBeanInstance#"/>
									</cfif>
								</cfloop>
							</cfinvoke>
							<cfcatch type="any">
						...
						<cfloop from="1" to="#arraylen(md.functions)#" index="functionIndex">
							<cfif md.functions[functionIndex].name eq "init"
								...
								<cfinvoke component="#beanInstance#" method="init">
									...
									<cfset argType = argDefs[argDefKeyArray[arg]].getType() />
										<cfif argType eq "value">
											<cfinvokeargument name="#argDefs[argDefKeyArray[arg]].getArgumentName()#"
															  value="#argDefs[argDefKeyArray[arg]].getValue()#"/>
										<cfelseif argType eq "list" or argType eq "map">
											<cfinvokeargument name="#argDefs[argDefKeyArray[arg]].getArgumentName()#"
															  value="#constructComplexProperty(argDefs[argDefKeyArray[arg]].getValue(),argDefs[argDefKeyArray[arg]].getType(), localBeanCache)#"/>
										<cfelseif argType eq "ref" or argType eq "bean">
											<cfinvokeargument name="#argDefs[argDefKeyArray[arg]].getArgumentName()#"
															  value="#getBean(argDefs[argDefKeyArray[arg]].getValue())#"/>
										</cfif>
									</cfloop>
								</cfinvoke>
