...
<cfcomponent name="coldspring.aop.framework.tmp.bean_E95BC5D4B4ACBD35E728426E1BBF1C5D" 
			displayname="AopProxyBean" 
			extends="coldspring.aop.framework.tmp.bean_E95BC35AD223F414F016C5EA27E3542A"
			hint="Abstract Base Class for Aop Proxy Beans" 
			output="false">
			
	<cffunction name="init" access="public" returntype="coldspring.aop.framework.tmp.bean_E95BC35AD223F414F016C5EA27E3542A" output="false">
