...
<cfcomponent name="AopProxyUtils" 
	...
	<cffunction name="createRemoteMethod" access="public" returntype="string" output="false">
		...
		<cfargument name="useAnyTypeForRemote" type="boolean" required="false" default="true"/>
		<cfargument name="useJsonReturnType" type="boolean" required="false" default="false"/>
		
		<cfreturn generateFunction(arguments.metaData, arguments.functionName, arguments.accessType,arguments.useAnyTypeForRemote,arguments.useJsonReturnType) />
	</cffunction> 
	...
	<cffunction name="generateFunction" access="private" returntype="string" output="false">
		...
		<cfif StructKeyExists(arguments,"accessType") AND (arguments.accessType IS 'remote') AND arguments.useAnyTypeForRemote>
		...
		<cfif arguments.useJsonReturnType>
			<cfset function = function & " returnFormat=""JSON""" />
		</cfif>
