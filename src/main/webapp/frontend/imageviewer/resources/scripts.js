/*
 * https://scanstore.cortsfoundation.org/imageviewer/?image=
 * http://repository.cortsfoundation.org/scans/179473/images/179496/file_2630234780814422748
 * http://repository.cortsfoundation.org/scans/179994/images/180017/file_266498203351353597
 */
...
$(document).ready(function(){
	...
	var iprocessor = new function(){
		...
		var process = function(){
			var pix = new Pixastic(ctx,'resources/pixastic/');
		...
		$("#viewer>img").on('load',function(){
			if(load){
				...
				$("#viewer>img").on( 'contextmenu', function(){ return false; });
			}
			if(boot){
				boot = false;
